    ...
    <div class="modal-content">
      ...
      <div class="modal-body">		
		...
		<div class="row">
			...
			<div class="col-sm-4">
				<input type="month" class="form-control" id="inspection_date" name="inspection_date" max="<?php echo date('Y-m'); ?>" required>
			</div>
		</div>
		<div class="row">			
			<div class="col-sm-2">
      ...
      <div class="modal-body">		
		...
		<div class="row">	
			...
			<div class="col-sm-4" id="div_view_file">
				<input type="file" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" class="form-control" id="inspection_file" name="inspection_file">
