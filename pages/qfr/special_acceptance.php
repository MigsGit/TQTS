  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
	 	<button type="button" id="is_replace_file_closed" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	  ...
	  <form id="frm_sa_edit" method="post" enctype="multipart/form-data">
		  <div class="modal-body">
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" id="" name="control_number" readonly required>
				</div>
			</div><br />
			<div class="row">
				<div class="col-sm-2">
				...
				<div id="container_uploaded_file" class="deletedField">
					<div class="col-sm-2">
						<label class="fa fa-md">Uploaded File: </label>
					</div>
					<div class="col-sm-4">
						<a href="#" id="uploaded_file"></a>
						<button type="button" class="btn btn-default fa fa-file-excel-o pull-right" id="replace_file"> Replace</button>
					</div>
				</div>
			</div>
			<div class="row">
			  ...
			  <div class="row">
					<div id="container_approver_name deletedField">
							<div class="col-sm-2">
									<label class="fa fa-md">Checked /Approved by : </label>
							</div>	
							<div class="col-sm-10" style="padding-top:5px;">
									<select class="form-control deletedField" name="judged_by_approvers[]" id="judged_by_approvers" style="width:100%;" multiple="multiple"> 
									</select>
							</div>
					</div>
					...
					<div id="container_main_approver_name">
						...
						<div class="col-sm-11 col-sm-offset-10 deletedField">
							<button class = "btn-success fa fa-plus" id="edit_btn_add_approver" style = "padding:5px;">Add Approvers</button>
						</div>
						<table class="table table-condensed table-bordered dataTable no-footer" id = "tbl_approver_view">
							<thead>
								<tr>
									<th>Order No.</th>
			  ...
			  <div class="row">
				...
				<div class="col-sm-12" style="padding-top:5px;">
					<div id="view_approver_field"></div> 
					<div id="view_main_approver_field"></div> 
				</div>
			</div>
		  ...
		  <div class="modal-footer">
			...
			<button type="button" class="btn btn-success main_approve " id="btn_sa_main_approve" style="display:none;"> Approve</button>
			<button type="button" class="btn btn-danger main_disapprove " id="btn_sa_main_disapprove" style="display:none;"> Disapprove</button>
			<button type="button" class="btn btn-default fa" id="close_default" data-dismiss="modal" style="display:none;"> Close</button>
		  </div>
