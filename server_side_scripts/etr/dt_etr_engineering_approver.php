...
//	 ini_set('display_errors', 1);
	...
	$aColumns = array( 
				'pkid', 
				'status', 
				'IF(status = "FOR ENGR CHECKING", 0, 1) AS status_id', 
				'training_title', 
				'training_objective', 
				'line', 
				'control_no', 
	...
	*/
	...
	$sWhere .= " (prdn_checked_by != '' AND prdn_checked_by_logs LIKE 'APPROVED%') AND engr_checked_by='".$username."' AND logdel=0";
	...
	while ( $aRow = mysql_fetch_array( $rResult ) )
	{
		...
		if($aRow['status'] == 'FOR ENGR CHECKING') {
