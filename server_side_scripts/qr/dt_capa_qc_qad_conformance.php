<?php
	...
	*/
	...
	$sWhere .= " (`1st_validation_conformed_by` LIKE '%".$username."%' OR `2nd_validation_conformed_by`  LIKE '%".$username."%' OR `3rd_validation_conformed_by` LIKE '%".$username."%' OR 
		`4th_validation_conformed_by` LIKE '%".$username."%' OR `5th_validation_conformed_by` LIKE '%".$username."%' OR `6th_validation_conformed_by` LIKE '%".$username."%' OR `7th_validation_conformed_by` LIKE '%".$username."%' OR 
		`8th_validation_conformed_by` LIKE '%".$username."%' OR `9th_validation_conformed_by` LIKE '%".$username."%' OR `10th_validation_conformed_by` LIKE '%".$username."%' OR `11th_validation_conformed_by` LIKE '%".$username."%' OR 
		`12th_validation_conformed_by` LIKE '%".$username."%')";
