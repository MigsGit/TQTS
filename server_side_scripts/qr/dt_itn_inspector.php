<?php
	...
	*/
	...
	$sWhere  .= " fp_inspected_by = '$username' AND logdel='0' ";
	// $sWhere 	= $sql_where;
	...
	while ( $aRow = mysql_fetch_array( $rResult ) )
	{
		...
		switch($aRow['status']){
			case "0" : $badge_class = "badge highlight-color-yellow"; $badge_text = "Pending Approval of Findings"; break;
			case "1" : $badge_class = "badge highlight-color-yellow"; break;
			case "2" : $badge_class = "badge highlight-color-yellow"; break;
			case "3" : $badge_class = "badge highlight-color-yellow"; break;
		}
