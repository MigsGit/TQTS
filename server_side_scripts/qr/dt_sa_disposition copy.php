<?php
	...
	*/
	...
	while ( $aRow = mysql_fetch_array( $rResult ) )
	{
		 ...
		 */
		// if($aRow['status'] == '0') {
		// 	$badge = '<span class="badge highlight-color-yellow" >FOR APPROVAL</span>';
		...
		if($aRow['status'] == '1') {
			...
			$badge = '<span class="badge highlight-color-green">APPROVED BY YEC</span>';
	 ...
	 */	
		 ...
		 */
			...
			$button[] = '<center>';
			if($user_sa_access['qc_supervisor']){
				if($aRow['status'] == '1'){
			...
			/*	else if($aRow['status'] == 6 || $aRow['status'] == 7){
					$button[] = '<button class="btn btn-dafault fa fa-eye" style="margin-bottom:5px;" id="'.$aRow['pkid'].'"> View</button>';
				}
			*/
			$button[] = '</center>';
