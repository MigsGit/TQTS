<?php
	...
	*/
	...
	while ( $aRow = mysql_fetch_array( $rResult ) )
	{
		...
		if($aRow['status'] == 'FOR VERIFICATION') {
			$badge 	   = '<span class="badge highlight-color-yellow" > PENDING VERIFICATION</span>';
		} else if(strstr($aRow['status'],'APPROVAL')) {
			$badge 	   = '<span class="badge highlight-color-yellow" > PENDING APPROVAL</span>';
		} else if(strstr($aRow['status'],'REJECT') || strstr($aRow['status'],'DISAPPROVED')) {
