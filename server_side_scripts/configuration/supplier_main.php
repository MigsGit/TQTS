<?php
	...
	$aColumns = array(  '`supplier`.`supplier`',
						'`supplier`.`fksupplier_group`',
	...
	$sIndexColumn = "`supplier`.pkid";
	
	/* DB table to use */
	$sTable = "tbl_supplier supplier INNER JOIN `tbl_supplier_group` `group` ON `supplier`.`fksupplier_group` = `group`.`pkid` ";
