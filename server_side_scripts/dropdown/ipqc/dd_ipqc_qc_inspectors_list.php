...
/* Query Here  */
$sql  = "SELECT `emp_name`,`user` FROM `vw_user_roles` WHERE `subsystem_code`='IPQC' AND `module`='Visual Inspection Result' AND `role`='INSPECTOR' AND `emp_name` LIKE '%$search%' AND `read`='1' AND `logdel`=0 LIMIT 0,10";
