...
/* Query Here  */
$sql  = "SELECT `emp_name`,`user` FROM `vw_user_roles` WHERE `subsystem_code`='ETR' AND `module`='ETR-QC Section' AND `emp_name` LIKE '%$search%' AND `update`='1' AND `logdel`=0 LIMIT 0,10";
