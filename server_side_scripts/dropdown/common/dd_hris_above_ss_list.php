...
/* Query Here  */
// $sql  = "SELECT CONCAT(`firstname`,' ',`lastname`) as `Emp_name`,`username` FROM vw_EmpInfo_Rapid WHERE (`lastname` LIKE '%$search%'  OR `firstname` LIKE '%$search%') AND Position_Level > 5 LIMIT 0,10";
