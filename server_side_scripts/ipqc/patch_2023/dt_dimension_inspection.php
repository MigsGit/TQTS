	...
	*/
	...
	while ( $aRow = mysql_fetch_array( $rResult ) )
	{
		...
		if($aRow['created_by'] == $username) {
			$btn = '<button type="button" class="btn btn-primary fa fa-edit" value="'.$aRow['pkid'].'"> Edit</button>';
		} else {
			$btn = '<button type="button" class="btn btn-primary fa fa-eye" value="'.$aRow['pkid'].'"> View</button>';
		}
