<?php
	...
	*/
	...
	/* DB table to use */
	$sTable = "tbl_yielding_performance";
	
	$database_config = '../../db_config/seiko_yielding.php';
	...
	*/
	...
	while ( $aRow = mysql_fetch_array( $rResult ) )
	{
		...
		$po_details  = 'PO #: '.$aRow['pono'].'<br>';
		$po_details .= 'PO Qty: '.$aRow['poqty'].'<br>';
		
		$device_details  = 'Device: '.$aRow['device'].'<br>';
		$device_details .= 'Family: '.$aRow['family'].'<br>';
		$device_details .= 'Series: '.$aRow['series'].'<br>';
