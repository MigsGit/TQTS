<?php
    ...
    $sIndexColumn = "partscode";
       
    /* DB table to use */
    $sTable = "vw_cn_warehouse_directory_main";
     
    /* Database connection information */
    require_once('../db_config/ypics_cn_db.php');
	$gaSql['user']       = $username;
