...
while($row_group = mysqli_fetch_assoc($result_group)){	
	...
	// echo json_encode($row_details['line']) ;
	...
	// 	$excel->place_value($capa_monitoring_col.$row,$row_tbl_oqc_lon_capa_monitoring['oqc_capa_action'],'string');
	// 	$capa_monitoring_col = 'L'; $row++;		
	// }
