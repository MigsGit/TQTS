...
$excel = new EXCEL;
/* set title */
$excel->title = $sql_data['section'].'-'.date('my', strtotime($sql_data['date_time_created'])).'-'.$sql_data['lon_ctr'];
$excel->add_sheet(0);
...
/* set file name */
$filename = $sql_data['section'].'-'.date('my', strtotime($sql_data['date_time_created'])).'-'.$sql_data['lon_ctr'];
