<?php
	...
	function add_engr_training() {
		...
		$array_fields 				  = array('status','check_items','check_items_value','eng_first_take_qualified_by','eng_first_take_date_time','eng_second_take_qualified_by','eng_second_take_date_time','engr_checked_by','engr_checked_by_logs','lastupdate', 'username');//novs edit 2019-06-27
		$array_values 				  = array($status, $check_items_id, $check_items_value, $eng_first_take_qualified_by, $eng_first_take_date_time, $eng_second_take_qualified_by, $eng_second_take_date_time, $username, $app_logs, $date_time_today, $username);//novs edit 2019-06-27
	...
	function add_qc_training() {
		...
		$status = 'FOR POSTING';
		$remarks = '';
		$app_logs	 		= 'APPROVED' . '|'.$date_time_today . '|'.$remarks;
